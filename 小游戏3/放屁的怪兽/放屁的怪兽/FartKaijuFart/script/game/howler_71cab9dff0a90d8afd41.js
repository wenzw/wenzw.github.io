    ...
    load: function() {
      ...
      if (self._webAudio) {
        ...
        var errorListener = function(){
        	...
        	newNode.removeEventListener('error', errorListener, false);
        	self.on('loaderror');
            return;
        };
        var emptiedListener = function(){
        	//console.log("load emptied error");
        	newNode.removeEventListener('emptied', emptiedListener, false);
        	self.on('loaderror');
            return;
        };
        var abortListener = function(){
        	//console.log("load abort error");
        	newNode.removeEventListener('abort', abortListener, false);
        	self.on('loaderror');
            return;
        };
        
        newNode.addEventListener('canplaythrough', listener, false);
        newNode.addEventListener('error', errorListener, false);
        newNode.addEventListener('abort', abortListener, false);
        newNode.addEventListener('emptied', emptiedListener, false);
        newNode.load();
      }
