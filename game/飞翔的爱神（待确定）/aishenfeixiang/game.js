...
(function(e) {
	...
	function a(e, t) {
		e = e || {}, this.IS_MASTER = e.isMaster, this.IS_STANDALONE = e.isStandalone, this.messenger = e.messenger, this.moduleReady = t ? t : !1, this.isAvailable = !1, this.locale = ""
	}
	function s(e, t) {
		e = e || {}, this.IS_MASTER = e.isMaster, this.IS_STANDALONE = e.isStandalone, this.messenger = e.messenger, this.moduleReady = t ? t : !1, this.isAvailable = !1
	}
	function r(e, t) {
	...
	function f(e, n, l, c, d) {
		this.version = "0.16.9", this.isReady = !1, this._setRole(), this.__ = {}, this.__.dataStore = this.IS_MASTER ? new e({
			isMaster: !0
	...
	(function(e) {
		...
		function n(e) {
			return "[object StopIteration]" === tt(e) || e instanceof J
		}
		function i(e, t) {
			if (B && t.stack && "object" == typeof e && null !== e && e.stack && -1 === e.stack.indexOf(nt)) {
		...
		function d() {
			function e(e) {
				t = e, s.source = e, Q(n, function(t, n) {
					W(function() {
			...
			if (s.promiseDispatch = function(e, a, s) {
				var r = K(arguments);
				n ? (n.push(r), "when" === a && s[1] && i.push(s[1])) : W(function() {
		...
		function A() {
			it.length = 0, at.length = 0, st || (st = !0)
		}
		function w(e, t) {
			st && (at.push(e), t && t.stack !== void 0 ? it.push(t.stack) : it.push("(no stack) " + t))
		}
		function E(e) {
			if (st) {
			...
			return function() {
				function t(e, t) {
					...
					if ("undefined" == typeof StopIteration) {
						...
						return r.done ? r.value : f(r.value, a, s)
					}
					try {
						r = i[e](t)
					} catch (o) {
		...
		function O(e) {
			return function() {
				return k([this, C(arguments)], function(t, n) {
					return e.apply(t, n)
				})
			}
		}
		...
		function C(e) {
			return f(e, function(e) {
				var t = 0,
					n = d();
				return Q(e, function(i, a, s) {
					var r;
					y(a) && "fulfilled" === (r = a.inspect()).state ? e[s] = r.value : (++t, f(a, function(i) {
		...
		var q, J, H = l(),
			...
			W = function() {
				function e() {
					for (; t.next;) {
						...
						try {
							...
							if (s) throw a && a.exit(), setTimeout(e, 0), a && a.enter(), r;
							setTimeout(function() {
								throw r
							}, 0)
						}
				...
				}, "undefined" != typeof process && process.nextTick) s = !0, a = function() {
					process.nextTick(e)
				};
		...
		c.resetUnhandledRejections = A, c.getUnhandledReasons = function() {
		...
		}, c.async = L, c.spawn = N, c["return"] = P, c.promised = O, c.dispatch = G, g.prototype.dispatch = function(e, t) {
			var n = this,
				i = d();
			return W(function() {
		...
		}, c.progress = D, g.prototype.progress = function(e) {
			...
			return function() {
				...
				var a = n.concat(K(arguments)),
					s = d();
				return a.push(s.makeNodeResolver()), c(i).fapply(a).fail(s.reject), s.promise
			}
		...
		}, c.nodeify = j, g.prototype.nodeify = function(e) {
	...
	y.getGameConfig = function() {
		...
		return SpilGames(["Net", "JSLib"], function(e, r) {
			e.send({
				url: [n, a, i, s].join("/"),
				type: "GET",
				dataType: "JSON"
				...
				if (e && e.configar) window.postMessage(new p({
					...
					var n = {};
					try {
						n = r.get("configar.data.cached") || n
					} catch (i) {}
					t.reject(n)
				}
			})
	...
	v.argsToArray = function(e) {
		...
		try {
			if ("www8.agame.com" === window.location.host) {
				var e = function(e, t, n, i, a, s, r) {
						...
						}, e[a].l = 1 * new Date, s = t.createElement(n), r = t.getElementsByTagName(n)[0], s.async = 1, s.src = i, r.parentNode.insertBefore(s, r)
					};
		...
		window.XDomainRequest ? (n = new XDomainRequest, n.onload = function() {
			...
			4 === n.readyState && t(n.status, n.responseText)
		}), r && (i = "576742227280294093.js", n.open("GET", i, !0), n.timeout = 3e3, n.ontimeout = function() {
			t(404, null)
		}, n.send())
	...
	S.getGameConfig = function() {
		...
		n.JSLib = {
			...
			if (200 === n && "string" == typeof a && JSON.parse(a)) {
				var s = JSON.parse(a);
				t.call(this, {
					branding: s.configar && s.configar.branding ? s.configar.branding : i.configar.branding,
					portal: {
						applicationId: e.id,
	...
	}, s.prototype.showInvite = function() {
		if (!this.moduleReady) throw Error("This method cannot be called before the API is loaded");
		...
		null], null, "log"))
	}, s.prototype.getFriends = function(e) {
		var t = this.messenger;
		if (!this.moduleReady) throw Error("This method cannot be called before the API is loaded");
		...
		null], null, "log"))
	}, s.prototype._getFriendsResponse = function(e) {
		this.friendscallback(this._validateData(e.friendList))
	}, s.prototype._validateData = function(e) {
		...
		return t
	}, r.prototype._setupMasterEvent = function() {
	...
	}, c.prototype._sendSETEvent = function(e, t, n) {}, c.prototype.trackGamePlay = function(e) {
		...
		return n = "string" == typeof t ? t : "logo", i = "brandedgames_" + (o > 0 && 500 > o ? "internal" : "external"), a = ["utm_medium=" + i, "utm_campaign=" + r.applicationId, "utm_source=" + s.host, "utm_content=" + n].join("&"), e += e.indexOf("?") > -1 ? "&" : "?", e + a
		...
		function o() {
			u.__.messenger.requestFromParent("GameAPI.isReady", {}, function(e) {
				l && clearTimeout(l), e.isready ? s() : 5 > d ? (d++, setTimeout(o, 500)) : s()
			})
		}
		var l, u = this,
		...
		null], null, "log"), this.IS_STANDALONE ? r() : this.IS_MASTER ? S.getGameConfig().then(function(e) {
			S.getBrandingConfig(e).then(function(t) {
				e && !e.isError && (e.branding = t.branding, u.__.dataStore._setCache(a(e))), i(e)
			})
		}) : (l = setTimeout(r, 600), o()), void 0)
	};
